...
public class playActivity extends AppCompatActivity {
    String[] question_list = {"Какая команда из перечисленных выигрывала требл?",
            "Какая команда больше всех выиграла лигу чемпионов?",
            "Сколько раз Лионель Месси выигрывал награду «Золотой мяч»?",
            "Как называется самая почетная персональная награда для футболиста?",
            "Сколько раз футбольный клуб Барселона выигрывал Лигу чемпионов?"
    };

    String[] choose_list = {"Реал мадрид","Тотенхем","Барселона","ПСЖ",
            "Мадрид","Милан","Барселона","Мюнхен",
            "3","5","7","8",
            "Золотой мятч","Статуэтка чемпиона","Золотая бутса","Кубок короля",
            "5","4","6","8"
    };

    String[] correct_list = {"Барселона","Мадрид","8","Золотой мятч","5"};
                ...
                view -> {
                    if (isclickBtn){
                        ...
                        if(!valueChoose.equals(correct_list[currentQuestion])){
                            Toast.makeText(playActivity.this , "Ошибка",Toast.LENGTH_LONG).show();
                        ...
                        Toast.makeText(playActivity.this ,  "Выберите один из вариантов",Toast.LENGTH_LONG).show();
                    }
                }
        );
